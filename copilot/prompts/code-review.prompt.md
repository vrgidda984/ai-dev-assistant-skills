...
3. Read `.github/copilot-instructions.md` for project-wide conventions.
4. Check `.github/instructions/` for stack-specific conventions that apply.
5. Review code against each checklist section below.
