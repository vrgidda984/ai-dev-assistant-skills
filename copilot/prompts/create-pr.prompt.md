---
mode: "agent"
description: "Create a draft pull request from current branch"
---
...
When you want to create a pull request for the current branch.
...
- Branch should already be pushed (suggest running commit-push prompt first if unpushed commits exist)
