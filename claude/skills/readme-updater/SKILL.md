...
name: readme-updater
description: >
  Synchronize README.md with current project state. This skill should be
  used when the project README is stale, when features have been added
  or removed, when setup steps change, or when the user says "update
  readme", "sync readme", "readme is outdated", "fix the readme".
---
...
If this skill doesn't auto-trigger, use: `/sync-readme`
