...
name: update-docs
description: >
  Update project documentation after code changes. This skill should be
  used when significant changes have been made to features, APIs,
  infrastructure, database schema, or architecture. Triggers on: "update
  docs", "sync documentation", "docs are stale", "documentation is
  outdated", or when Claude detects code changes not yet reflected in docs/.
---
...
If this skill doesn't auto-trigger, use: `/update-docs`
